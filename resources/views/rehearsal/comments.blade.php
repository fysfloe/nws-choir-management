...
@section('rehearsalContent')
    ...
    <div class="tab-pane fade show active" id="comments" role="tabpanel" aria-labelledby="info-tab">
        <div class="row comment-stream">
            <div class="col">
                @if (count($rehearsal->comments) > 0)
                    @foreach ($rehearsal->comments as $comment)
                            ...
                            <div class="col-md-3 flex comment-info">
                                ...
                                <div>
                                    <strong>
                                        ...
                                        &nbsp;<span class="accept-decline oi oi-media-record {{ $rehearsal->promises->contains($comment->user) ? 'text-success' : ($rehearsal->denials->contains($comment->user) ? 'text-danger' : 'text-muted') }}"></span>
                                    </strong><br> 
        ...
        <div class="row">
            <div class="col">
            {{ Form::model(new App\Comment(), ['route' => ['rehearsal.createComment', $rehearsal]]) }}
