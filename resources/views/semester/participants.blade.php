        ...
        @if(count($participants) > 0)
            <div class="list-table">
                <header class="row">
                    <div class="col-md-8">
                        {{ __('User') }}
                        <a class="list-sort {{ app('request')->input('sort') === 'surname' && app('request')->input('dir') === 'ASC' ? 'active' : '' }}" href="{{ route('semester.participants', [$semester, 'sort' => 'surname', 'dir' => 'ASC']) }}">
                            <span class="oi oi-caret-top"></span>
                        </a>
                        <a class="list-sort {{ app('request')->input('sort') === 'surname' && app('request')->input('dir') === 'DESC' ? 'active' : '' }}" href="{{ route('semester.participants', [$semester, 'sort' => 'surname', 'dir' => 'DESC']) }}">
